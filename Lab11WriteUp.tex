...
\FunctionTok{ggplot}\NormalTok{(raw) }\SpecialCharTok{+}
  ...
  \FunctionTok{ggtitle}\NormalTok{(}\StringTok{"S1 vs S2 from 1000 simulations for different distributions"}\NormalTok{) }\SpecialCharTok{+}
...
\pandocbounded{\includegraphics[keepaspectratio]{Lab11WriteUp_files/figure-pdf/unnamed-chunk-3-1.pdf}}
...
\NormalTok{S1\_pois }\OtherTok{\textless{}{-}} \FunctionTok{list}\NormalTok{()}
\NormalTok{S2\_pois }\OtherTok{\textless{}{-}} \FunctionTok{list}\NormalTok{()}
...
\NormalTok{  \}}
  \CommentTok{\# convert number to string to use as a name}
\NormalTok{  S1\_pois[[}\FunctionTok{as.character}\NormalTok{(n)]] }\OtherTok{\textless{}{-}}\NormalTok{ S1}
\NormalTok{  S2\_pois[[}\FunctionTok{as.character}\NormalTok{(n)]] }\OtherTok{\textless{}{-}}\NormalTok{ S2}
\NormalTok{\}}

\CommentTok{\# raw data }
\NormalTok{raw\_pois }\OtherTok{\textless{}{-}} \FunctionTok{tibble}\NormalTok{(}
  \AttributeTok{Estimator =} \FunctionTok{rep}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\StringTok{"S1"}\NormalTok{, }\StringTok{"S2"}\NormalTok{), }\AttributeTok{each =} \DecValTok{1000}\NormalTok{, }\AttributeTok{times =} \DecValTok{4}\NormalTok{),}
  \CommentTok{\# so that they\textquotesingle{}re in order}
  \AttributeTok{n =} \FunctionTok{factor}\NormalTok{(}\FunctionTok{rep}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\StringTok{"n=20"}\NormalTok{, }\StringTok{"n=50"}\NormalTok{, }\StringTok{"n=100"}\NormalTok{, }\StringTok{"n=500"}\NormalTok{), }\AttributeTok{each =} \DecValTok{2000}\NormalTok{),}
            \AttributeTok{levels =} \FunctionTok{c}\NormalTok{(}\StringTok{"n=20"}\NormalTok{, }\StringTok{"n=50"}\NormalTok{, }\StringTok{"n=100"}\NormalTok{, }\StringTok{"n=500"}\NormalTok{)),}
  \AttributeTok{Estimate =} \FunctionTok{c}\NormalTok{(S1\_pois[[}\StringTok{"20"}\NormalTok{]], S2\_pois[[}\StringTok{"20"}\NormalTok{]],}
\NormalTok{              S1\_pois[[}\StringTok{"50"}\NormalTok{]], S2\_pois[[}\StringTok{"50"}\NormalTok{]],}
\NormalTok{              S1\_pois[[}\StringTok{"100"}\NormalTok{]], S2\_pois[[}\StringTok{"100"}\NormalTok{]],}
\NormalTok{              S1\_pois[[}\StringTok{"500"}\NormalTok{]], S2\_pois[[}\StringTok{"500"}\NormalTok{]])}
\NormalTok{)}
\CommentTok{\# summary }
\NormalTok{results\_pois }\OtherTok{\textless{}{-}} \FunctionTok{tibble}\NormalTok{(}
  \AttributeTok{n =} \FunctionTok{rep}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\DecValTok{20}\NormalTok{, }\DecValTok{50}\NormalTok{, }\DecValTok{100}\NormalTok{, }\DecValTok{500}\NormalTok{), }\AttributeTok{each=}\DecValTok{2}\NormalTok{),}
  \AttributeTok{Estimator =} \FunctionTok{rep}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\StringTok{"S1"}\NormalTok{, }\StringTok{"S2"}\NormalTok{), }\AttributeTok{times =} \DecValTok{4}\NormalTok{),}
  \AttributeTok{Bias =} \FunctionTok{c}\NormalTok{(}
    \FunctionTok{mean}\NormalTok{(S1\_pois[[}\StringTok{"20"}\NormalTok{]]) }\SpecialCharTok{{-}} \DecValTok{2}\NormalTok{, }\FunctionTok{mean}\NormalTok{(S2\_pois[[}\StringTok{"20"}\NormalTok{]]) }\SpecialCharTok{{-}} \DecValTok{2}\NormalTok{,}
    \FunctionTok{mean}\NormalTok{(S1\_pois[[}\StringTok{"50"}\NormalTok{]]) }\SpecialCharTok{{-}} \DecValTok{2}\NormalTok{, }\FunctionTok{mean}\NormalTok{(S2\_pois[[}\StringTok{"50"}\NormalTok{]]) }\SpecialCharTok{{-}} \DecValTok{2}\NormalTok{,}
    \FunctionTok{mean}\NormalTok{(S1\_pois[[}\StringTok{"100"}\NormalTok{]]) }\SpecialCharTok{{-}} \DecValTok{2}\NormalTok{, }\FunctionTok{mean}\NormalTok{(S2\_pois[[}\StringTok{"100"}\NormalTok{]]) }\SpecialCharTok{{-}} \DecValTok{2}\NormalTok{,}
    \FunctionTok{mean}\NormalTok{(S1\_pois[[}\StringTok{"500"}\NormalTok{]]) }\SpecialCharTok{{-}} \DecValTok{2}\NormalTok{, }\FunctionTok{mean}\NormalTok{(S2\_pois[[}\StringTok{"500"}\NormalTok{]]) }\SpecialCharTok{{-}} \DecValTok{2}
\NormalTok{  ),}
  \AttributeTok{Variance =} \FunctionTok{c}\NormalTok{(}
    \FunctionTok{var}\NormalTok{(S1\_pois[[}\StringTok{"20"}\NormalTok{]]),  }\FunctionTok{var}\NormalTok{(S2\_pois[[}\StringTok{"20"}\NormalTok{]]),}
    \FunctionTok{var}\NormalTok{(S1\_pois[[}\StringTok{"50"}\NormalTok{]]),  }\FunctionTok{var}\NormalTok{(S2\_pois[[}\StringTok{"50"}\NormalTok{]]),}
    \FunctionTok{var}\NormalTok{(S1\_pois[[}\StringTok{"100"}\NormalTok{]]), }\FunctionTok{var}\NormalTok{(S2\_pois[[}\StringTok{"100"}\NormalTok{]]),}
    \FunctionTok{var}\NormalTok{(S1\_pois[[}\StringTok{"500"}\NormalTok{]]), }\FunctionTok{var}\NormalTok{(S2\_pois[[}\StringTok{"500"}\NormalTok{]])}
\NormalTok{  ),}
  \AttributeTok{Precision =} \DecValTok{1} \SpecialCharTok{/}\NormalTok{ Variance,}
  \AttributeTok{MSE =}\NormalTok{ Bias}\SpecialCharTok{\^{}}\DecValTok{2} \SpecialCharTok{+}\NormalTok{ Variance)}
...
\begin{Highlighting}[numbers=left,,]
\CommentTok{\# plot}
\FunctionTok{ggplot}\NormalTok{(raw\_pois) }\SpecialCharTok{+}
  \FunctionTok{geom\_boxplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ Estimator,}
                   \AttributeTok{y=}\NormalTok{ Estimate),}
               \AttributeTok{width =} \FloatTok{0.1}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{ggtitle}\NormalTok{(}\StringTok{"S1 vs S2 from 1000 simulations across sample size"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{theme}\NormalTok{(}\AttributeTok{axis.ticks.x =} \FunctionTok{element\_blank}\NormalTok{()) }\SpecialCharTok{+}
  \FunctionTok{facet\_wrap}\NormalTok{(}\SpecialCharTok{\textasciitilde{}}\NormalTok{ n) }
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{Lab11WriteUp_files/figure-pdf/unnamed-chunk-7-1.pdf}}
...
\NormalTok{S1\_binom }\OtherTok{\textless{}{-}} \FunctionTok{list}\NormalTok{()}
\NormalTok{S2\_binom }\OtherTok{\textless{}{-}} \FunctionTok{list}\NormalTok{()}

\ControlFlowTok{for}\NormalTok{(n }\ControlFlowTok{in}\NormalTok{ ss)\{}
\NormalTok{  S1 }\OtherTok{\textless{}{-}} \FunctionTok{rep}\NormalTok{(}\ConstantTok{NA}\NormalTok{, n.sims)}
\NormalTok{  S2 }\OtherTok{\textless{}{-}} \FunctionTok{rep}\NormalTok{(}\ConstantTok{NA}\NormalTok{, n.sims)}
  \ControlFlowTok{for}\NormalTok{(i }\ControlFlowTok{in} \DecValTok{1}\SpecialCharTok{:}\NormalTok{n.sims)\{}
\NormalTok{    curr.sample }\OtherTok{\textless{}{-}}\NormalTok{ curr.sample }\OtherTok{\textless{}{-}} \FunctionTok{rbinom}\NormalTok{(}\AttributeTok{n =}\NormalTok{ n, }\AttributeTok{size =} \DecValTok{50}\NormalTok{, }\AttributeTok{prob =}\NormalTok{ p)}
\NormalTok{    x\_bar }\OtherTok{\textless{}{-}} \FunctionTok{mean}\NormalTok{(curr.sample)}
\NormalTok{    S1[i] }\OtherTok{\textless{}{-}} \FunctionTok{sum}\NormalTok{((curr.sample }\SpecialCharTok{{-}}\NormalTok{ x\_bar)}\SpecialCharTok{\^{}}\DecValTok{2}\NormalTok{) }\SpecialCharTok{/}\NormalTok{ (n }\SpecialCharTok{{-}} \DecValTok{1}\NormalTok{)}
\NormalTok{    S2[i] }\OtherTok{\textless{}{-}} \FunctionTok{sum}\NormalTok{((curr.sample }\SpecialCharTok{{-}}\NormalTok{ x\_bar)}\SpecialCharTok{\^{}}\DecValTok{2}\NormalTok{) }\SpecialCharTok{/}\NormalTok{ n}
\NormalTok{  \}}
\NormalTok{  S1\_binom[[}\FunctionTok{as.character}\NormalTok{(n)]] }\OtherTok{\textless{}{-}}\NormalTok{ S1}
\NormalTok{  S2\_binom[[}\FunctionTok{as.character}\NormalTok{(n)]] }\OtherTok{\textless{}{-}}\NormalTok{ S2}
\NormalTok{\}}

\CommentTok{\# raw data }
\NormalTok{raw\_binom }\OtherTok{\textless{}{-}} \FunctionTok{tibble}\NormalTok{(}
  \AttributeTok{Estimator =} \FunctionTok{rep}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\StringTok{"S1"}\NormalTok{, }\StringTok{"S2"}\NormalTok{), }\AttributeTok{each =} \DecValTok{1000}\NormalTok{, }\AttributeTok{times =} \DecValTok{4}\NormalTok{),}
  \AttributeTok{n =} \FunctionTok{factor}\NormalTok{(}\FunctionTok{rep}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\StringTok{"n=20"}\NormalTok{, }\StringTok{"n=50"}\NormalTok{, }\StringTok{"n=100"}\NormalTok{, }\StringTok{"n=500"}\NormalTok{), }\AttributeTok{each =} \DecValTok{2000}\NormalTok{),}
            \AttributeTok{levels =} \FunctionTok{c}\NormalTok{(}\StringTok{"n=20"}\NormalTok{, }\StringTok{"n=50"}\NormalTok{, }\StringTok{"n=100"}\NormalTok{, }\StringTok{"n=500"}\NormalTok{)),}
  \AttributeTok{Estimate =} \FunctionTok{c}\NormalTok{(S1\_binom[[}\StringTok{"20"}\NormalTok{]], S2\_binom[[}\StringTok{"20"}\NormalTok{]],}
\NormalTok{              S1\_binom[[}\StringTok{"50"}\NormalTok{]], S2\_binom[[}\StringTok{"50"}\NormalTok{]],}
\NormalTok{              S1\_binom[[}\StringTok{"100"}\NormalTok{]], S2\_binom[[}\StringTok{"100"}\NormalTok{]],}
\NormalTok{              S1\_binom[[}\StringTok{"500"}\NormalTok{]], S2\_binom[[}\StringTok{"500"}\NormalTok{]])}
\NormalTok{)}
\CommentTok{\# summary }
\NormalTok{results\_binom }\OtherTok{\textless{}{-}} \FunctionTok{tibble}\NormalTok{(}
  \AttributeTok{n =} \FunctionTok{rep}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\DecValTok{20}\NormalTok{, }\DecValTok{50}\NormalTok{, }\DecValTok{100}\NormalTok{, }\DecValTok{500}\NormalTok{), }\AttributeTok{each=}\DecValTok{2}\NormalTok{),}
  \AttributeTok{Estimator =} \FunctionTok{rep}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\StringTok{"S1"}\NormalTok{, }\StringTok{"S2"}\NormalTok{), }\AttributeTok{times =} \DecValTok{4}\NormalTok{),}
  \AttributeTok{Bias =} \FunctionTok{c}\NormalTok{(}
    \FunctionTok{mean}\NormalTok{(S1\_binom[[}\StringTok{"20"}\NormalTok{]]) }\SpecialCharTok{{-}} \DecValTok{2}\NormalTok{, }\FunctionTok{mean}\NormalTok{(S2\_binom[[}\StringTok{"20"}\NormalTok{]]) }\SpecialCharTok{{-}} \DecValTok{2}\NormalTok{,}
    \FunctionTok{mean}\NormalTok{(S1\_binom[[}\StringTok{"50"}\NormalTok{]]) }\SpecialCharTok{{-}} \DecValTok{2}\NormalTok{, }\FunctionTok{mean}\NormalTok{(S2\_binom[[}\StringTok{"50"}\NormalTok{]]) }\SpecialCharTok{{-}} \DecValTok{2}\NormalTok{,}
    \FunctionTok{mean}\NormalTok{(S1\_binom[[}\StringTok{"100"}\NormalTok{]]) }\SpecialCharTok{{-}} \DecValTok{2}\NormalTok{, }\FunctionTok{mean}\NormalTok{(S2\_binom[[}\StringTok{"100"}\NormalTok{]]) }\SpecialCharTok{{-}} \DecValTok{2}\NormalTok{,}
    \FunctionTok{mean}\NormalTok{(S1\_binom[[}\StringTok{"500"}\NormalTok{]]) }\SpecialCharTok{{-}} \DecValTok{2}\NormalTok{, }\FunctionTok{mean}\NormalTok{(S2\_binom[[}\StringTok{"500"}\NormalTok{]]) }\SpecialCharTok{{-}} \DecValTok{2}
\NormalTok{  ),}
  \AttributeTok{Variance =} \FunctionTok{c}\NormalTok{(}
    \FunctionTok{var}\NormalTok{(S1\_binom[[}\StringTok{"20"}\NormalTok{]]),  }\FunctionTok{var}\NormalTok{(S2\_binom[[}\StringTok{"20"}\NormalTok{]]),}
    \FunctionTok{var}\NormalTok{(S1\_binom[[}\StringTok{"50"}\NormalTok{]]),  }\FunctionTok{var}\NormalTok{(S2\_binom[[}\StringTok{"50"}\NormalTok{]]),}
    \FunctionTok{var}\NormalTok{(S1\_binom[[}\StringTok{"100"}\NormalTok{]]), }\FunctionTok{var}\NormalTok{(S2\_binom[[}\StringTok{"100"}\NormalTok{]]),}
    \FunctionTok{var}\NormalTok{(S1\_binom[[}\StringTok{"500"}\NormalTok{]]), }\FunctionTok{var}\NormalTok{(S2\_binom[[}\StringTok{"500"}\NormalTok{]])}
\NormalTok{  ),}
  \AttributeTok{Precision =} \DecValTok{1} \SpecialCharTok{/}\NormalTok{ Variance,}
  \AttributeTok{MSE =}\NormalTok{ Bias}\SpecialCharTok{\^{}}\DecValTok{2} \SpecialCharTok{+}\NormalTok{ Variance)}

\CommentTok{\# table}
\NormalTok{results\_binom }\SpecialCharTok{|\textgreater{}}\NormalTok{ knitr}\SpecialCharTok{::}\FunctionTok{kable}\NormalTok{(}\AttributeTok{digits =} \DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[numbers=left,,]
\CommentTok{\# plot}
\FunctionTok{ggplot}\NormalTok{(raw\_binom) }\SpecialCharTok{+}
  \FunctionTok{geom\_boxplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ Estimator,}
                   \AttributeTok{y=}\NormalTok{ Estimate),}
               \AttributeTok{width =} \FloatTok{0.1}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{ggtitle}\NormalTok{(}\StringTok{"S1 vs S2 from 1000 simulations across sample size"}\NormalTok{) }\SpecialCharTok{+}
...
\pandocbounded{\includegraphics[keepaspectratio]{Lab11WriteUp_files/figure-pdf/unnamed-chunk-8-1.pdf}}
...
\NormalTok{S1\_norm }\OtherTok{\textless{}{-}} \FunctionTok{list}\NormalTok{()}
\NormalTok{S2\_norm }\OtherTok{\textless{}{-}} \FunctionTok{list}\NormalTok{()}
...
\NormalTok{    S2[i] }\OtherTok{\textless{}{-}} \FunctionTok{sum}\NormalTok{((curr.sample }\SpecialCharTok{{-}}\NormalTok{ x\_bar)}\SpecialCharTok{\^{}}\DecValTok{2}\NormalTok{) }\SpecialCharTok{/}\NormalTok{ n}
\NormalTok{  \}}
\NormalTok{  S1\_norm[[}\FunctionTok{as.character}\NormalTok{(n)]] }\OtherTok{\textless{}{-}}\NormalTok{ S1}
\NormalTok{  S2\_norm[[}\FunctionTok{as.character}\NormalTok{(n)]] }\OtherTok{\textless{}{-}}\NormalTok{ S2}
\NormalTok{\}}

\CommentTok{\# raw data }
\NormalTok{raw\_norm }\OtherTok{\textless{}{-}} \FunctionTok{tibble}\NormalTok{(}
  \AttributeTok{Estimator =} \FunctionTok{rep}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\StringTok{"S1"}\NormalTok{, }\StringTok{"S2"}\NormalTok{), }\AttributeTok{each =} \DecValTok{1000}\NormalTok{, }\AttributeTok{times =} \DecValTok{4}\NormalTok{),}
  \AttributeTok{n =} \FunctionTok{factor}\NormalTok{(}\FunctionTok{rep}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\StringTok{"n=20"}\NormalTok{, }\StringTok{"n=50"}\NormalTok{, }\StringTok{"n=100"}\NormalTok{, }\StringTok{"n=500"}\NormalTok{), }\AttributeTok{each =} \DecValTok{2000}\NormalTok{),}
            \AttributeTok{levels =} \FunctionTok{c}\NormalTok{(}\StringTok{"n=20"}\NormalTok{, }\StringTok{"n=50"}\NormalTok{, }\StringTok{"n=100"}\NormalTok{, }\StringTok{"n=500"}\NormalTok{)),}
  \AttributeTok{Estimate =} \FunctionTok{c}\NormalTok{(S1\_norm[[}\StringTok{"20"}\NormalTok{]], S2\_norm[[}\StringTok{"20"}\NormalTok{]],}
\NormalTok{              S1\_norm[[}\StringTok{"50"}\NormalTok{]], S2\_norm[[}\StringTok{"50"}\NormalTok{]],}
\NormalTok{              S1\_norm[[}\StringTok{"100"}\NormalTok{]], S2\_norm[[}\StringTok{"100"}\NormalTok{]],}
\NormalTok{              S1\_norm[[}\StringTok{"500"}\NormalTok{]], S2\_norm[[}\StringTok{"500"}\NormalTok{]])}
\NormalTok{)}
\CommentTok{\# summary }
\NormalTok{results\_norm }\OtherTok{\textless{}{-}} \FunctionTok{tibble}\NormalTok{(}
  \AttributeTok{n =} \FunctionTok{rep}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\DecValTok{20}\NormalTok{, }\DecValTok{50}\NormalTok{, }\DecValTok{100}\NormalTok{, }\DecValTok{500}\NormalTok{), }\AttributeTok{each=}\DecValTok{2}\NormalTok{),}
  \AttributeTok{Estimator =} \FunctionTok{rep}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\StringTok{"S1"}\NormalTok{, }\StringTok{"S2"}\NormalTok{), }\AttributeTok{times =} \DecValTok{4}\NormalTok{),}
  \AttributeTok{Bias =} \FunctionTok{c}\NormalTok{(}
    \FunctionTok{mean}\NormalTok{(S1\_norm[[}\StringTok{"20"}\NormalTok{]]) }\SpecialCharTok{{-}} \DecValTok{2}\NormalTok{, }\FunctionTok{mean}\NormalTok{(S2\_norm[[}\StringTok{"20"}\NormalTok{]]) }\SpecialCharTok{{-}} \DecValTok{2}\NormalTok{,}
    \FunctionTok{mean}\NormalTok{(S1\_norm[[}\StringTok{"50"}\NormalTok{]]) }\SpecialCharTok{{-}} \DecValTok{2}\NormalTok{, }\FunctionTok{mean}\NormalTok{(S2\_norm[[}\StringTok{"50"}\NormalTok{]]) }\SpecialCharTok{{-}} \DecValTok{2}\NormalTok{,}
    \FunctionTok{mean}\NormalTok{(S1\_norm[[}\StringTok{"100"}\NormalTok{]]) }\SpecialCharTok{{-}} \DecValTok{2}\NormalTok{, }\FunctionTok{mean}\NormalTok{(S2\_norm[[}\StringTok{"100"}\NormalTok{]]) }\SpecialCharTok{{-}} \DecValTok{2}\NormalTok{,}
    \FunctionTok{mean}\NormalTok{(S1\_norm[[}\StringTok{"500"}\NormalTok{]]) }\SpecialCharTok{{-}} \DecValTok{2}\NormalTok{, }\FunctionTok{mean}\NormalTok{(S2\_norm[[}\StringTok{"500"}\NormalTok{]]) }\SpecialCharTok{{-}} \DecValTok{2}
\NormalTok{  ),}
  \AttributeTok{Variance =} \FunctionTok{c}\NormalTok{(}
    \FunctionTok{var}\NormalTok{(S1\_norm[[}\StringTok{"20"}\NormalTok{]]),  }\FunctionTok{var}\NormalTok{(S2\_norm[[}\StringTok{"20"}\NormalTok{]]),}
    \FunctionTok{var}\NormalTok{(S1\_norm[[}\StringTok{"50"}\NormalTok{]]),  }\FunctionTok{var}\NormalTok{(S2\_norm[[}\StringTok{"50"}\NormalTok{]]),}
    \FunctionTok{var}\NormalTok{(S1\_norm[[}\StringTok{"100"}\NormalTok{]]), }\FunctionTok{var}\NormalTok{(S2\_norm[[}\StringTok{"100"}\NormalTok{]]),}
    \FunctionTok{var}\NormalTok{(S1\_norm[[}\StringTok{"500"}\NormalTok{]]), }\FunctionTok{var}\NormalTok{(S2\_norm[[}\StringTok{"500"}\NormalTok{]])}
\NormalTok{  ),}
  \AttributeTok{Precision =} \DecValTok{1} \SpecialCharTok{/}\NormalTok{ Variance,}
  \AttributeTok{MSE =}\NormalTok{ Bias}\SpecialCharTok{\^{}}\DecValTok{2} \SpecialCharTok{+}\NormalTok{ Variance)}

\CommentTok{\# table}
\NormalTok{results\_norm }\SpecialCharTok{|\textgreater{}}\NormalTok{ knitr}\SpecialCharTok{::}\FunctionTok{kable}\NormalTok{(}\AttributeTok{digits =} \DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[numbers=left,,]
\CommentTok{\# plot}
\FunctionTok{ggplot}\NormalTok{(raw\_norm) }\SpecialCharTok{+}
  \FunctionTok{geom\_boxplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ Estimator,}
                   \AttributeTok{y=}\NormalTok{ Estimate),}
               \AttributeTok{width =} \FloatTok{0.1}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{ggtitle}\NormalTok{(}\StringTok{"S1 vs S2 from 1000 simulations across sample size"}\NormalTok{) }\SpecialCharTok{+}
...
\pandocbounded{\includegraphics[keepaspectratio]{Lab11WriteUp_files/figure-pdf/unnamed-chunk-9-1.pdf}}
...
\NormalTok{S1\_exp }\OtherTok{\textless{}{-}} \FunctionTok{list}\NormalTok{()}
\NormalTok{S2\_exp }\OtherTok{\textless{}{-}} \FunctionTok{list}\NormalTok{()}
...
\NormalTok{    S2[i] }\OtherTok{\textless{}{-}} \FunctionTok{sum}\NormalTok{((curr.sample }\SpecialCharTok{{-}}\NormalTok{ x\_bar)}\SpecialCharTok{\^{}}\DecValTok{2}\NormalTok{) }\SpecialCharTok{/}\NormalTok{ n}
\NormalTok{  \}}
\NormalTok{  S1\_exp[[}\FunctionTok{as.character}\NormalTok{(n)]] }\OtherTok{\textless{}{-}}\NormalTok{ S1}
\NormalTok{  S2\_exp[[}\FunctionTok{as.character}\NormalTok{(n)]] }\OtherTok{\textless{}{-}}\NormalTok{ S2}
\NormalTok{\}}

\CommentTok{\# raw data }
\NormalTok{raw\_exp }\OtherTok{\textless{}{-}} \FunctionTok{tibble}\NormalTok{(}
  \AttributeTok{Estimator =} \FunctionTok{rep}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\StringTok{"S1"}\NormalTok{, }\StringTok{"S2"}\NormalTok{), }\AttributeTok{each =} \DecValTok{1000}\NormalTok{, }\AttributeTok{times =} \DecValTok{4}\NormalTok{),}
  \AttributeTok{n =} \FunctionTok{factor}\NormalTok{(}\FunctionTok{rep}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\StringTok{"n=20"}\NormalTok{, }\StringTok{"n=50"}\NormalTok{, }\StringTok{"n=100"}\NormalTok{, }\StringTok{"n=500"}\NormalTok{), }\AttributeTok{each =} \DecValTok{2000}\NormalTok{),}
            \AttributeTok{levels =} \FunctionTok{c}\NormalTok{(}\StringTok{"n=20"}\NormalTok{, }\StringTok{"n=50"}\NormalTok{, }\StringTok{"n=100"}\NormalTok{, }\StringTok{"n=500"}\NormalTok{)),}
  \AttributeTok{Estimate =} \FunctionTok{c}\NormalTok{(S1\_exp[[}\StringTok{"20"}\NormalTok{]], S2\_exp[[}\StringTok{"20"}\NormalTok{]],}
\NormalTok{              S1\_exp[[}\StringTok{"50"}\NormalTok{]], S2\_exp[[}\StringTok{"50"}\NormalTok{]],}
\NormalTok{              S1\_exp[[}\StringTok{"100"}\NormalTok{]], S2\_exp[[}\StringTok{"100"}\NormalTok{]],}
\NormalTok{              S1\_exp[[}\StringTok{"500"}\NormalTok{]], S2\_exp[[}\StringTok{"500"}\NormalTok{]])}
\NormalTok{)}
\CommentTok{\# summary }
\NormalTok{results\_exp }\OtherTok{\textless{}{-}} \FunctionTok{tibble}\NormalTok{(}
  \AttributeTok{n =} \FunctionTok{rep}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\DecValTok{20}\NormalTok{, }\DecValTok{50}\NormalTok{, }\DecValTok{100}\NormalTok{, }\DecValTok{500}\NormalTok{), }\AttributeTok{each=}\DecValTok{2}\NormalTok{),}
  \AttributeTok{Estimator =} \FunctionTok{rep}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\StringTok{"S1"}\NormalTok{, }\StringTok{"S2"}\NormalTok{), }\AttributeTok{times =} \DecValTok{4}\NormalTok{),}
  \AttributeTok{Bias =} \FunctionTok{c}\NormalTok{(}
    \FunctionTok{mean}\NormalTok{(S1\_exp[[}\StringTok{"20"}\NormalTok{]]) }\SpecialCharTok{{-}} \DecValTok{2}\NormalTok{, }\FunctionTok{mean}\NormalTok{(S2\_exp[[}\StringTok{"20"}\NormalTok{]]) }\SpecialCharTok{{-}} \DecValTok{2}\NormalTok{,}
    \FunctionTok{mean}\NormalTok{(S1\_exp[[}\StringTok{"50"}\NormalTok{]]) }\SpecialCharTok{{-}} \DecValTok{2}\NormalTok{, }\FunctionTok{mean}\NormalTok{(S2\_exp[[}\StringTok{"50"}\NormalTok{]]) }\SpecialCharTok{{-}} \DecValTok{2}\NormalTok{,}
    \FunctionTok{mean}\NormalTok{(S1\_exp[[}\StringTok{"100"}\NormalTok{]]) }\SpecialCharTok{{-}} \DecValTok{2}\NormalTok{, }\FunctionTok{mean}\NormalTok{(S2\_exp[[}\StringTok{"100"}\NormalTok{]]) }\SpecialCharTok{{-}} \DecValTok{2}\NormalTok{,}
    \FunctionTok{mean}\NormalTok{(S1\_exp[[}\StringTok{"500"}\NormalTok{]]) }\SpecialCharTok{{-}} \DecValTok{2}\NormalTok{, }\FunctionTok{mean}\NormalTok{(S2\_exp[[}\StringTok{"500"}\NormalTok{]]) }\SpecialCharTok{{-}} \DecValTok{2}
\NormalTok{  ),}
  \AttributeTok{Variance =} \FunctionTok{c}\NormalTok{(}
    \FunctionTok{var}\NormalTok{(S1\_exp[[}\StringTok{"20"}\NormalTok{]]),  }\FunctionTok{var}\NormalTok{(S2\_exp[[}\StringTok{"20"}\NormalTok{]]),}
    \FunctionTok{var}\NormalTok{(S1\_exp[[}\StringTok{"50"}\NormalTok{]]),  }\FunctionTok{var}\NormalTok{(S2\_exp[[}\StringTok{"50"}\NormalTok{]]),}
    \FunctionTok{var}\NormalTok{(S1\_exp[[}\StringTok{"100"}\NormalTok{]]), }\FunctionTok{var}\NormalTok{(S2\_exp[[}\StringTok{"100"}\NormalTok{]]),}
    \FunctionTok{var}\NormalTok{(S1\_exp[[}\StringTok{"500"}\NormalTok{]]), }\FunctionTok{var}\NormalTok{(S2\_exp[[}\StringTok{"500"}\NormalTok{]])}
\NormalTok{  ),}
  \AttributeTok{Precision =} \DecValTok{1} \SpecialCharTok{/}\NormalTok{ Variance,}
  \AttributeTok{MSE =}\NormalTok{ Bias}\SpecialCharTok{\^{}}\DecValTok{2} \SpecialCharTok{+}\NormalTok{ Variance)}

\CommentTok{\# table}
\NormalTok{results\_exp }\SpecialCharTok{|\textgreater{}}\NormalTok{ knitr}\SpecialCharTok{::}\FunctionTok{kable}\NormalTok{(}\AttributeTok{digits =} \DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[numbers=left,,]
\CommentTok{\# plot}
\FunctionTok{ggplot}\NormalTok{(raw\_exp) }\SpecialCharTok{+}
  \FunctionTok{geom\_boxplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ Estimator,}
                   \AttributeTok{y=}\NormalTok{ Estimate),}
               \AttributeTok{width =} \FloatTok{0.1}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{ggtitle}\NormalTok{(}\StringTok{"S1 vs S2 from 1000 simulations across sample size"}\NormalTok{) }\SpecialCharTok{+}
...
\pandocbounded{\includegraphics[keepaspectratio]{Lab11WriteUp_files/figure-pdf/unnamed-chunk-10-1.pdf}}
